...
```shell
go get github.com/gopythoncoder/neo4j-go-driver/v5
```
...
Go package API documentation [here](https://pkg.go.dev/github.com/gopythoncoder/neo4j-go-driver/v5/neo4j).
